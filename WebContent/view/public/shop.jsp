                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="<%=request.getContextPath() %>/images/<%= p.getImage() %>" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="<%= request.getContextPath()%>/detail?pid=<%= p.getId() %>" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Compare"><i class="fas fa-sync-alt"></i></a></li>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"><i class="far fa-heart"></i></a></li>
                                                        </ul>
                                                        <% if (session.getAttribute("userLogin")!= null){ %>
                                                        <a class="cart" href="javascript:void(0)" onclick="addToCard(<%=p.getNumber()%>, <%=p.getId()%>)">Add to Cart</a>
                                                        <% } %>
                                                    </div>
                                                </div>
                                                <div class="why-text">
