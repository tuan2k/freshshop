                    ...
                    <form class="mt-3 collapse review-form-box" id="formRegister">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="rusername" placeholder="UserName"> </div>
                            <div class="form-group col-md-6">
                                <label for="InputLastname" class="mb-0">Full Name</label>
                                <input type="text" class="form-control" id="fullname" placeholder="FullName"> </div>
                            <div class="form-group col-md-6">
                                <label for="InputEmail1" class="mb-0">Mobile</label>
                                <input type="text" class="form-control" id="mobile" placeholder="Enter Mobile"> </div>
                            <div class="form-group col-md-6">
                                <label for="InputPassword1" class="mb-0">Password</label>
                                <input type="password" class="form-control" id="rpassword" placeholder="Password"> </div>
                            <div class="form-group col-md-6">
                                <label for="InputLastname" class="mb-0">Address</label>
                                <input type="text" class="form-control" id="address" placeholder="Address"> </div>
                            <div class="form-group col-md-6">
                                <label for="InputLastname" class="mb-0">Gender</label>
                                <input type="radio" name ="gender"class="form-control" id="gender" placeholder="gender" value="Nam"> Nam
                                <input type="radio" name = "gender" class="form-control" id="gender" placeholder="gender" value="Nu"> Nu
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="payment-icon">
                                        <ul>
                                            <li><img class="img-fluid" src="<%=request.getContextPath() %>/images/payment-icon/1.png" alt=""></li>
                                            <li><img class="img-fluid" src="<%=request.getContextPath() %>/images/payment-icon/2.png" alt=""></li>
                                            <li><img class="img-fluid" src="<%=request.getContextPath() %>/images/payment-icon/3.png" alt=""></li>
                                            <li><img class="img-fluid" src="<%=request.getContextPath() %>/images/payment-icon/5.png" alt=""></li>
                                            <li><img class="img-fluid" src="<%=request.getContextPath() %>/images/payment-icon/7.png" alt=""></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
        ...
        $('#register').click(function(e)
                {   
                   ...
                   $.ajax({
                        ...
                        data:{"username":user,"password":pwd, "fullname":fn, "mobile":mob,"address":adr,"gender":gender},
                        success: function (data) {
                           if(data =='True'){
                        	   var successUrl = "checkout.jsp"; // might be a good idea to return this URL in the successful AJAX call
                        	   window.location.href = successUrl;
                           }else{
                               alert('Fail....');
                           }
