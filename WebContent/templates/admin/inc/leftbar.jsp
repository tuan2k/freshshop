...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <a id="song" href="<%= request.getContextPath() %>/admin/product/index"><i class="fa fa-music fa-3x"></i> Quản lý sản phẩm</a>
            </li>
            <li>
                <a id="user" href="<%= request.getContextPath() %>/admin/user/index"><i class="fa fa-user fa-3x"></i> Quản lý người dùng</a>
            </li>
            <li>
                <a id="contact" href="<%= request.getContextPath() %>/admin/order/index"><i class="fa fa-envelope fa-3x"></i> Quản lý đơn hàng</a>
            </li>
            
            <li>
                <a id="contact" href="<%= request.getContextPath() %>/admin/chart/total"><i class="fa fa-envelope fa-3x"></i>Thống kê</a>
            </li>
